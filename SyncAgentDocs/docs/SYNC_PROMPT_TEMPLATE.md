...
- 섹션 3: TO 호출 대상 메서드 존재 확인 표 — **3.1 매니저 메서드 / 3.2 UI 컴포넌트 메서드 / 3.3 Show<T> UI 클래스 / 3.4 partial 내부 참조 / 3.5 호출 그래프 역방향 추적 / 3.6 시그니처 축 변경 매핑** (✅ / ⚠️)
...
sync 규칙: 첨부한 WD_SYNC_GUIDE.md (규칙 1~16) 적용
...
첨부한 WD_SYNC_GUIDE.md (규칙 1~16)를 적용해.
